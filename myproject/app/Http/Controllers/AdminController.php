...
class AdminController extends Controller
{
    ...
    public function post_ThemTin(TinTucRequest $req)
    {
    ...
    {   
        ...
        $listTinTuc=CT_TinTuc::where('username',Session::get('username'))->orderBy('created_at','desc')->get();
