...
<body style="background-image: url({{asset('assets/img/sky.jpg')}});background-repeat: no-repeat;background-size: cover" >
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    {{-- <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="POST" action="#">
        <input type="text" name="query" placeholder="Nhập tên đồ vật, vật nuôi" title="Enter search keyword">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/admin/tin-tuc-nguoi-dung">          
