...
Route::get('/admin/bai-dang',[AdminController::class,'index']);
...
Route::get('/admin/quan-ly',[QuanLyController::class,'NguoiDung'])->name('adminhome')->middleware('admin');
Route::get('/admin/quan-ly-nguoi-dung',[QuanLyController::class,'NguoiDung'])->middleware('admin');
Route::get('/admin/quan-ly-tin-tuc',[QuanLyController::class,'TinTuc'])->middleware('admin');
Route::get('/admin/quan-ly-danh-muc',[DanhMucController::class,'index'])->middleware('admin');


Route::get('/admin/quan-ly-them-tin',[QuanLyController::class,'ThemTin'])->middleware('auth');
Route::post('/admin/quan-ly-them-tin',[QuanLyController::class,'post_ThemTin'])->name('admin-quan-ly-xu-li-them-tin')->middleware('auth');

Route::get('/admin/quan-ly-them-nguoi-dung',[QuanLyController::class,'ThemNguoiDung'])->middleware('auth');
Route::post('/admin/quan-ly-them-nguoi-dung',[QuanLyController::class,'post_ThemNguoiDung'])->name('admin-quan-xu-li-them-nguoi-dung')->middleware('auth');

Route::get('/admin/quan-ly-them-danh-muc',[DanhMucController::class,'create'])->middleware('auth');
Route::post('/admin/quan-ly-them-danh-muc',[DanhMucController::class,'store'])->name('admin-xu-li-them-danh-muc')->middleware('auth');


Route::get('/admin/quan-ly-cap-nhat-nguoi-dung/{id}',[QuanLyController::class,'CapNhatNguoiDungi'])->middleware('auth');
Route::post('/admin/quan-ly-cap-nhat-nguoi-dung/{id}',[QuanLyController::class,'post_CapNhatNguoiDung'])->name('admin-xu-li-cap-nhat-nguoi-dung')->middleware('auth');
Route::get('/admin/quan-ly-xoa-nguoi-dung/{id}',[QuanLyController::class,'XoaNguoiDung'])->name('admin-xoa-nguoi-dung')->middleware('auth');

Route::get('/admin/quan-ly-cap-nhat-tin-tuc/{id}',[QuanLyController::class,'CapNhatTinTuc'])->middleware('auth');
Route::post('/admin/quan-ly-cap-nhat-tin-tuc/{id}',[QuanLyController::class,'post_CapNhatTinTuc'])->name('admin-xu-li-cap-nhat-tin-tuc')->middleware('auth');
Route::get('/admin/quan-ly-xoa-tin-tuc/{id}',[QuanLyController::class,'XoaTinTuc'])->name('admin-xoa-tin-tuc')->middleware('auth');

Route::get('/admin/quan-ly-cap-nhat-danh-muc/{id}',[DanhMucController::class,'edit'])->middleware('auth');
Route::post('/admin/quan-ly-cap-nhat-danh-muc/{id}',[DanhMucController::class,'update'])->name('admin-xu-li-cap-nhat-danh-muc')->middleware('auth');
Route::get('/admin/quan-ly-xoa-danh-muc/{id}',[DanhMucController::class,'destroy'])->name('admin-xoa-danh-muc')->middleware('auth');
//Route cho quản lý(admin)
